...
<fieldset class="adminform"><legend><?php echo JText::_ ( 'Import/Export' ); ?></legend>
	...
	<tr>
		 <td class="key">
		  ...
		  <td>
		  <a href="index.php?option=com_djfappend&controller=loader&task=backup" title="<?php echo JText::_ ( 'AGGIORNA_FILE_BACKUP' ); ?>">
		  <img src="components/com_djfacl/assets/images/toolbar/icon-32-export.png"/>
		   </a>
	...
	<tr>
		 <td class="key" style="width:190px;">
		  ...
		  $filename="";
		   if (! file_exists ( JPATH_BASE . DS . "components".DS."com_djfappend".DS."backup" )) {
			mkdir ( JPATH_BASE . DS . "components".DS."com_djfappend".DS."backup", 0777 );
		}
		  if (! file_exists ( JPATH_BASE . DS . "components".DS."com_djfappend".DS."backup".DS."backup" )) {
			mkdir ( JPATH_BASE . DS . "components".DS."com_djfappend".DS."backup".DS."backup", 0777 );
		}
		  $files = JFolder::files( JPATH_BASE . DS . "components".DS."com_djfappend".DS."backup" ,'.', false, false );
		  ...
		  ?>
			<a href="components/com_djfappend/backup/<?php echo $filename; ?>" TYPE="application/zip"><?php echo $filename; ?></a>
		</td>
	</tr>
	<tr>
		 <td class="key">
