...
class field_typeModelfield_type extends JModel {
	...
	function _buildQuery() {
		...
		$query = ' SELECT h.* FROM ' . $this->_table_prefix . 'field_type as h where h.id=h.id '. $query_search . $orderby;
		//echo ($query);
