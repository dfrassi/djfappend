...
var form = document.adminForm;
   if (pressbutton)
    {form.task.value=pressbutton;}
	 ...
	 {
	  form.controller.value="field_type_detail";
	 }
	try {
		form.onsubmit();
		}
...
<div id="editcell">
	...
	<thead>
		<tr >
			...
			<th width="30%" nowrap="nowrap" class="title"  style="text-align:left;">
				<?php echo JHTML::_('grid.sort', 'description', 'h.description', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				
			</th>
				<th width="30%" nowrap="nowrap" class="title"  style="text-align:left;">
				<?php echo JHTML::_('grid.sort', 'options', 'h.options', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	...
	{
		$row = &$this->items[$i];
		$link 	= JRoute::_( 'index.php?option=com_djfappend&controller=field_type_detail&task=edit&cid[]='. $row->id );
...
<input type="hidden" name="controller" value="field_type" />
