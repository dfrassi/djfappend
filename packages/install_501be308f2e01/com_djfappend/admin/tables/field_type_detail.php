 ...
 * @since 1.0
 */
class Tablefield_type_detail extends JTable {
	 ...
	 * @since 1.0
	 */
	function Tablefield_type_detail(& $db) {
		//initialize class property
		$this->_table_prefix = '#__djfappend_';
		
		parent::__construct ( $this->_table_prefix . 'field_type', 'id', $db );
	}
	...
	function check()
	{
		...
		$query = 'SELECT id FROM '.$this->_table_prefix.'field_type  WHERE id = '.$this->id;
